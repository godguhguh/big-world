...
import com.ypp.tunte.world.junitpractice.parameterized.CsvToPerson;
import com.ypp.tunte.world.junitpractice.parameterized.MyArgumentsProvider;
import com.ypp.tunte.world.junitpractice.parameterized.Person;
import com.ypp.tunte.world.junitpractice.parameterized.PersonAggregator;
...
public class HelloTest {
    ...
    // 用@ParameterizedTest取代@Test，表名此方法要执行参数化测试
    @ParameterizedTest
    // 指定每次测试时的参数来自字符串类型的数组：{ “a”, “b”, “c” }，每个元素执行一次
   ...
   @NullSource
    ...
    @ParameterizedTest
    @MethodSource("com.ypp.tunte.world.junitpractice.Utils#getStringStream")
